...
bool in_test_mode = false; // use to retrafic Bluetooth while in test
 //Buffer for pubx processing
char pubx_buffer[120];
PUBX pubx(pubx_buffer, sizeof(pubx_buffer));
...
void setup() {
  ...
  Serial.begin(9600); //Uart0 for programming and debugging
...
void loop() {
  ...
  if (currentMillis - previousMillis >1000)
  {
    ...
    delay(100);
    Serial.println();
    Serial.println(pubx.getHour());
    Serial.println(pubx.getMinute());
    Serial.println(pubx.getSecond());
    Serial.print("Latitude (deg): ");
    Serial.println(pubx.getLatitude() / 1000000., 6);
    Serial.print("Longitude (deg): ");
    Serial.println(pubx.getLongitude() / 1000000., 6);
    Serial.print("Altitude: ");
    Serial.println(pubx.getAltitude());
    Serial.print("Altitude Ref: ");
    Serial.println(pubx.getAltitudeRef());
    Serial.print("hAcc: ");
    Serial.println(pubx.getHorizontalAccuracy());
    Serial.print("vAcc: ");
    Serial.println(pubx.getVerticalAccuracy());
    Serial.print("Num of satellite: ");
    Serial.println(pubx.getNumSatellite());
    Serial.print("Nav System: ");
    Serial.println(pubx.getNavSystem());
    Serial.print("HDOP: ");
    Serial.println(pubx.getHDOP());
  }
}
